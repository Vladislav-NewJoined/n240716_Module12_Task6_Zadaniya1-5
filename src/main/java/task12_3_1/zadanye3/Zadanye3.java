...
public class Zadanye3 {
    ...
    public static void main(String[] args) {
        ...
        try (MongoClient mongoClient = MongoClients.create(connectionString)) {
            database = mongoClient.getDatabase("mongoTest2");
        }
        ...
        // Пример чтения данных из коллекции
        FindIterable<org.bson.Document> documents = collection.find();
        for (Document doc : documents) {
            System.out.println(doc.toJson());
        }

        // Здесь вы можете выполнять другие операции с базой данных, такие как вставка, обновление и удаление данных
