...
public class Zadanye5 {
    public static void main(String[] args) {
        ...
        try (var mongoClient = MongoClients.create("mongodb://localhost:27017")) {
            ...
            // Отображаем только столбцы "first_name" и "phone_number"
            FindIterable<Document> documents = collection.find().projection(
                    Projections.include("first_name", "phone_number"));

            // Печатаем заголовки столбцов
            System.out.println("first_name\t\t|\tphone_number");
            System.out.println("--------------------------------");
